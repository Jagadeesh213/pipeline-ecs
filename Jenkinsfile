  ...
  stages {
   ...
   stage('Docker build and push') {
	 ...
	 echo $access_key
         ...
         docker build -t 399071157173.dkr.ecr.ap-south-1.amazonaws.com/sample:SAMPLE-PROJECT-${BUILD_NUMBER} .
         docker push 399071157173.dkr.ecr.ap-south-1.amazonaws.com/sample:SAMPLE-PROJECT-${BUILD_NUMBER}
